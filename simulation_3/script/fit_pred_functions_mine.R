...
source("~/Documents/github-folder-name/inference.R")
source("~/Documents/github-folder-name/models.R")
source("~/Documents/github-folder-name/utils.R")

mrbs.svc.fit <- function(dat, ids){
